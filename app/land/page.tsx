...
const PAINS = [
  ...
  { icon: ArchiveX, title: "14-18% счетов с отказом", text: "Столько отказов и недоплат по ДМС получают клиники без системного учёта писем." },
...
export default async function LandingPage({
  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-16 px-5 py-12">
      ...
      {/* Отраслевой факт — усреднение 14-18→16 и 5-7→6 по источнику (формулировка владельца 26.07) */}
      <section className="rounded-xl border border-primary/40 bg-muted/30 p-5">
        <p className="text-lg font-medium">
          ...
          страховых в среднем с 16% до 6% счетов.
        </p>
