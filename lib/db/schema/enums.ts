...
// Тип ДОКУМЕНТА/записи (что это): гарантийное письмо, прикрепление, открепление, аннулирование,
// направление на обследование и пр. Определяет смысл даты «до» (гарантийное → окончание письма;
// прикрепление → когда откреплять). Расширять аддитивно.
export const docTypeEnum = pgEnum("doc_type", [
  "guarantee", // гарантийное письмо (согласование услуг)
  "enroll", // прикрепление — список застрахованных на прикрепление
  "detach", // открепление — снять пациента с обслуживания
  "annul", // аннулирование ранее выданного ГП
  "referral", // направление на обследование/консультацию
  "denial", // отказ
...
// Статус согласования/обработки (бриф §7.3 + открепление/прикрепление/аннулирование).
export const approvalStatusEnum = pgEnum("approval_status", [
  "approved", // согласовано
  "denied", // отказано
  "detach", // ОТКРЕПИТЬ — снять пациента с обслуживания
  "enroll", // прикрепить — список застрахованных на прикрепление
  "annul", // АННУЛИРОВАТЬ — признать ранее выданное гарантийное письмо недействительным
