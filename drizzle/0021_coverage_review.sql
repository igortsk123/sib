...
DO $$ BEGIN
  ALTER TABLE "coverage_rule" ADD CONSTRAINT "coverage_rule_carried_from_fk"
    FOREIGN KEY ("carried_from_document_id") REFERENCES "public"."program_document"("id") ON DELETE set null ON UPDATE no action;
