...
- ⏭ **Очередь (следующее):**
  1. **БОЛЬШОЙ срез — демо рабочего реестра ГП из корпуса:** распарсить 51 письмо по схеме (ADR D10) →
     реестр с поиском + карточка со ссылкой на оригинал + выгрузка в Excel; по ходу править схему. Цель —
     показать клинике готовый продукт. (отдельный план; переиспользовать концепции админки sup2.)
  2. Выбор клиники у платформенного админа (контекст реестра).
