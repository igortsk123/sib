...
- ⏭ **Очередь:** IMAP-забор (роадмап S1 — прод-пайплайн на сервере: тулзы pdftotext/striprtf/xlrd/libreoffice
  в Docker-образе); правка полей в карточке; тоньше роли; vision на реальные сканы.
