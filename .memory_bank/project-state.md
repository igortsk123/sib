...
- ⏭ **Дальше (по выбору владельца):** распознавание (роадмап `plans/recognition-roadmap.md`, S1 IMAP — отложен)
  ИЛИ доработки админки. IMAP-забор сейчас НЕ в приоритете (сначала показать результат клинике).
