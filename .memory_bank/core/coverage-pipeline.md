...
вердикт); **чат по правилам** — главный UI карточки (D41): история в БД, общая на пациента,
автор виден; правила целиком + хвост истории в LLM; без LLM — детерминированный ответ;
