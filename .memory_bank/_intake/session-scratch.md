...
- 2026-07-27 — Демо-экспорт «Дентал Про» был почти пустой (стенд залит до фикса D42) → backfill --demo + синтетика fill_demo_gaps.sql; пустых 0/3730 — ADR D44; при перегенерации стенда оба шага обязательны.
