...
- 2026-07-26 — ГИПОТЕЗА (не подтверждена): возможно, подключается второй клиент «Дентал Про» — при подтверждении владельцем завести онбординг в память (guides/onboarding.md).
- 2026-07-26 — Директ API грабли: vcards.add отключён («не поддерживается»), TextAd.Title2 молча игнорируется (warning 10165, новый формат объявлений) — второй заголовок и визитку можно только в UI. DailyBudget минимум 300₽/д.
